...
const HeroSection = () => {
  ...
  // Parse heading with <accent> tags
  ...
  const renderDescription = (text: string) => {
    ...
    return parts.map((part, i) =>
      i % 2 === 1 ? <span key={i} className="text-foreground font-medium">{part}</span> : part
    );
  };
      ...
      <div className="container mx-auto relative">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12 lg:gap-8">
          ...
          <motion.div
            ...
            style={{ width: 400, height: 480, perspective: 800 }}
          >
            <motion.div
            ...
            >
              ...
              <motion.img
                ...
                style={{ x: imgX, y: imgY, filter: "drop-shadow(0 8px 24px hsl(0 0% 0% / 0.15))" }}
              />
        ...
        <motion.div
          ...
          transition={{ delay: 1.2, duration: 1 }} className="mt-24"
        >
          <button
